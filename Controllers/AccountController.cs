    ...
    public class AccountController : Controller, IUpdateModel
    {
        ...
        public ActionResult Register()
        {
            ...
            if (_orchardServices.WorkContext.CurrentUser != null) {
                _orchardServices.Notifier.Error(T("You are already registered"));
                return Redirect("~");
            }
        ...
        public ActionResult Register(string userName, string email, string password, string confirmPassword)
        {
            ...
            if (ValidateRegistration(userName, email, password, confirmPassword))
            {
                ...
                if (user != null)
                {
                    ...
                    if (userPart2.EmailStatus == UserStatus.Pending)
                    {
                        _userService.SendChallengeEmail(userPart2, nonce => Url.AbsoluteAction(() => Url.Action("ChallengeEmail", "Account", new { Area = "Orchard.Users", nonce = nonce })));
                    ...
                    if (userPart2.RegistrationStatus == UserStatus.Pending)
                    {
